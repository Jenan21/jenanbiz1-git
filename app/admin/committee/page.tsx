...
const fallbackCommittee: CommitteeItem[] = [
  { id: "c1", robotName: "المجلس-01", reviewer: "مراجعة استراتيجية", score: 98, verdict: "APPROVE", notes: "أولوية على مستوى الإدارة" },
  { id: "c2", robotName: "المجلس-07", reviewer: "تحليل النمو", score: 97, verdict: "APPROVE", notes: "اكتشاف الفرص" },
  { id: "c3", robotName: "المجلس-12", reviewer: "صحة المنظومة", score: 96, verdict: "APPROVE", notes: "الصحة والأتمتة" },
];

export default function CommitteePage() {
  const [committee, setCommittee] = useState<CommitteeItem[]>(fallbackCommittee);
